...
public class FoConstants {
	...
	public static final String ACGH_INTENSITY = "aCGH (intensity)";
	public static final String ACGH_STATUS = "aCGH (status)";
	...
	public static final String TISSUE_SELECT_MULTI = "tissue_select_multi";
	public static final String TISSUE_SELECT_SINGLE = "tissue_select_single";
}
