...
public class NorthPanel extends HLayout{
	...
	public NorthPanel(MainPanel mainPanel) {
		...
		infoLbl.setContents("Copyright (c) 2009-2014 Malte Mader <br>" +
							"Copyright (c) 2009-2014 Center for Bioinformatics, University of Hamburg <br>" +
							"Copyright (c) 2009-2014 Department of Pathology University Medical Center Hamburg-Eppendorf");
