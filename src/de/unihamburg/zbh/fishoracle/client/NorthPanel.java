...
public class NorthPanel extends HLayout{
	...
	public NorthPanel(MainPanel mainPanel) {
		...
		infoLbl.setContents("Copyright (c) 2009-2013 Malte Mader <br>" +
							"Copyright (c) 2009-2013 Center for Bioinformatics, University of Hamburg <br>" +
							"Copyright (c) 2009-2013 Department of Pathology University Medical Center Hamburg-Eppendorf");
