...
needed along with their individual dependencies:\documentclass{beamer}
\usepackage{graphicx}

\usetheme{ZBH}

\author{Malte Mader}
\title{FISH Oracle: a web server for flexible
visualization of DNA copy number data in a
genomic context}
\date{\today}
...
\begin{frame}{FISH Oracle Interface}
  \begin{center}
    \includegraphics[width=\textwidth]{frontend_new_icons.png}
  \end{center}
\end{frame}
