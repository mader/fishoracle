...
The current version of FISH Oracle works up to Ensembl version 58.
For example, to retrieve the annotations from Ensembl release 58, download from
\url{ftp://ftp.ensembl.org/pub/release-58/mysql}.

For instance, to download the human genome annotation execute the following
command in a terminal:

\begin{lstlisting}
> wget -r -nd ftp://ftp.ensembl.org/pub/release-58/mysql/homo_sapiens_core_58_37c
\end{lstlisting}
...
> mysql -u <mysql_user> -p ensembl < homo_sapiens_core_58_37c.sql
